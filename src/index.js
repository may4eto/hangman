...
class ButtonPad extends React.Component {
  ...
  render() {
    ...
    return <div className="letterGrid">{letterGrid}</div>;
  }
}
...
class Hangman extends React.Component {
  ...
  componentDidMount() {
    fetch(
      "https://api.wordnik.com/v4/words.json/randomWords?hasDictionaryDef=true&includePartOfSpeech=noun%2Cadjective%2Cverb&excludePartOfSpeech=abbreviation%2Cfamily-name%2Cgiven-name&maxCorpusCount=-1&minDictionaryCount=1&maxDictionaryCount=-1&minLength=5&maxLength=10&limit=1&api_key=p7ahenott7ylvlxk6wtmlo1e3sf7hfr5im0dtgw1r5am7sjpo"
    )
        ...
        <div className="row my-5">
          <div className="col-12 d-flex align-items-center justify-content-center">
            <div className="wrapper d-flex flex-column align-items-center justify-content-center bg-white py-4 px-3 p-md-5">
              ...
              <footer className="text-center small text-secondary">
                Maya Mircheva @ EnvatoTuts, 2021
              </footer>
            </div>
          </div>
        </div>
